...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 0.5; // Default is 4.8 meters per second <- Slowing it down for testing
    public static final double kMaxAngularSpeed = 0.2 * 2 * Math.PI; // radians per second
