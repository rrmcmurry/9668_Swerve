...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 0.5; // Default is 4.8 meters per second <- Slowed this down for testing
    // public static final double kMaxAngularSpeed = 2 * Math.PI; // Default is 2 PI radians (one full rotation) per second 
    public static final double kMaxAngularSpeed = 0.2 * 2 * Math.PI; // radians per second <- Slowed this down for testing
